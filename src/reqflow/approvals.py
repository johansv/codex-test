"""Moved from src/agentlab/utils/approvals.py on 2025-10-27."""
...
_DEFAULT_CONFIG_RELATIVE = Path("assets") / "reqflow" / "approval-policy.toml"
...
def _read_config_flag(path: Path) -> bool | None:
    ...
    try:
        ...
        raise ApprovalError(f"Invalid approval config at {path}: {exc.msg}") from exc
